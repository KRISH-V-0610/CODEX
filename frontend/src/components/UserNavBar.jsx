     ...
     <nav className="font-[raleway] bg-black text-white px-6 py-4 shadow-lg select-none">
       <div className="container mx-auto flex justify-between items-center">
         ...
         <div
           ...
           AutoCode<i className="text-4xl mb-1">X</i>
         </div>
         ...
         <button
            onClick={logout}
            className="invisible cursor-pointer relative px-4 py-2 overflow-hidden font-bold rounded-full group">
            ...
            <span className="flex items-center gap-2 relative w-full text-left text-white transition-colors duration-200 ease-in-out">LogOut</span>
         ...
         onClick={onProfileClick}
            ...
            <span className="flex items-center gap-2 relative w-full text-left text-white transition-colors duration-200 ease-in-out group-hover:text-gray-900">{authUser.username}</span>
            <span className="absolute inset-0 rounded-full"></span>
          </button>
